/*
This is OggatoSet dataset anonymizer written in C++ using the libtorch library
...
int main() {
    ...
    torch::jit::script::Module container = torch::jit::load("Imagenette.pt");
    ...
    for(int level = 0; level < 4; level++) {
        ...
        string train_name = "Imagenette_train_" + to_string(aug_level) + ".pt";
        string test_name = "Imagenette_test_" + to_string(aug_level) + ".pt";
